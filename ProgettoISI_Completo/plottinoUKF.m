...
log_vars.x = double(log_UKF.x_hat(:,1)');
log_vars.y = double(log_UKF.x_hat(:,2)');
log_vars.thetas = double(log_UKF.x_hat(:,3)');
log_vars.phi_dots=double(log_UKF.x_hat(:,4)');
log_vars.psis=double(log_UKF.x_hat(:,5)');
log_vars.psi_dots=double(log_UKF.x_hat(:,6)');
