...
log_vars.x = double(log_EKF.x_hat_smoothed(:,1)');
log_vars.y = double(log_EKF.x_hat_smoothed(:,2)');
log_vars.thetas = double(log_EKF.x_hat_smoothed(:,3)');
log_vars.phi_dots=double(log_EKF.x_hat_smoothed(:,4)');
log_vars.psis=double(log_EKF.x_hat_smoothed(:,5)');
log_vars.psi_dots=double(log_EKF.x_hat_smoothed(:,6)');
